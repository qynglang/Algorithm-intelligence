...
from data_gen_2 import g_error
...
def fullnet(fc1, weights, biases, dropout):
    ...
    return out
# Training Parameters
def train_fcon(pic,weight1,weight2,n,bs,ans,N):
    Num=0
    learning_rate = 0.001
    num_steps = n
    batch_size = bs
    ...
    # Network Parameters
    num_input = 36 # MNIST data input (img shape: 28*28)
    ...
    weights = {
        ...
        'wd1': tf.Variable(tf.random_normal([36, 1024])),
    ...
    with tf.Session() as sess:
        ...
        for step in range(1, num_steps+1):
            batch_x, batch_y = g_error(pic,weight1,weight2,ans,N)
